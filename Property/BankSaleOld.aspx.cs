    ...
    public partial class BankSale : System.Web.UI.Page
    {
        ...
        public void SendMailToAdmin(string UserEmailId)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                mail.Subject = "Ajay Chopra : '" + txtFirstName.Text + " :  " + txtPhoneNo.Text;
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>Ajay Chopra for Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                ...
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>Ajay Chopra<br/>Broker of record</p>");
